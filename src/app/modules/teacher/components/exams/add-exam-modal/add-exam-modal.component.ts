        ...
        <div class="modal-body">
          <form [formGroup]="examForm" (ngSubmit)="onSubmit()">
            <div class="form-group">
              ...
              <div
                class="error-message"
                *ngIf="examForm.get('name')?.errors?.['required'] && examForm.get('name')?.touched"
              >
                Name is required
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div
                class="error-message"
                *ngIf="examForm.get('subjectId')?.errors?.['required'] && examForm.get('subjectId')?.touched"
              >
                Subject is required
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div
                class="error-message"
                *ngIf="examForm.get('numQuestions')?.errors?.['required'] && examForm.get('numQuestions')?.touched"
              >
            ...
            <div class="form-group">
              ...
              <div
                class="error-message"
                *ngIf="examForm.get('passingMarks')?.errors?.['required'] && examForm.get('passingMarks')?.touched"
              >
            ...
            <div class="form-group">
              ...
              <div
                class="error-message"
                *ngIf="examForm.get('totalMarks')?.errors?.['required'] && examForm.get('totalMarks')?.touched"
              >
            ...
            <div class="form-group">
              ...
              <div
                class="error-message"
                *ngIf="examForm.get('duration')?.errors?.['required'] && examForm.get('duration')?.touched"
              >
            ...
            <div class="form-group">
              ...
              <div
                class="error-message"
                *ngIf="examForm.get('startDate')?.errors?.['required'] && examForm.get('startDate')?.touched"
              >
            ...
            <div class="form-group">
              ...
              <div
                class="error-message"
                *ngIf="examForm.get('endDate')?.errors?.['required'] && examForm.get('endDate')?.touched"
              >
